...
export default function Contact() {
  ...
  const handleSubmit = async e => {
    ...
    // API call will go here tomorrow
    ...
    <section className="section" id="contact">
      <div className="container contact-wrapper">
        <div className="contact-info">
          ...
          {/* Updated with your actual email from your CV! */}
          <p className="contact-email">zainabbilal597@gmail.com</p>

          {/* Social Links */}
          <div style={{ display: 'flex', gap: '20px', marginTop: '32px' }}>
            <a 
              href="https://github.com/zainab845" 
              target="_blank" 
              rel="noreferrer"
            ...
            <a 
              href="https://www.linkedin.com/in/zainab-bilal-31b063283/" 
              target="_blank" 
              rel="noreferrer"
              style={{ color: 'var(--color-text-muted)', transition: 'color 0.2s' }}
              onMouseEnter={(e) => e.currentTarget.style.color = 'var(--color-primary)'}
